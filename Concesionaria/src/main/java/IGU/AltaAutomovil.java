...
public class AltaAutomovil extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (camposVacios(modelo, marca, motor, color, patente, Puertas)) {
            MostrarMensaje("Debes completar todos los campos", "Error", "Registro");
        } else {
            //Parseo de la obtencion de la cant de puertas para su registro
            int cantPuertas = Integer.parseInt(Puertas);
    ...
    //Metodo para control de campos vacios
