...
public class InformacionEquipoTecnico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tpObservaciones.setEditable(false);
        ...
        btnActualizar.setText("Comentar y actualizar");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        String status, comentariosTecnico;
        
        status = cbMarca.getSelectedItem().toString();
        comentariosTecnico = tpComentariosTecnico.getText();
        

            try {
                Connection cn = Conexion.Conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "UPDATE equipos SET status = ?, comentarios_tec = ?,"
                                + " revision_tecnica = ?  WHERE ID_equipo = '" + idEquipo + "'");
